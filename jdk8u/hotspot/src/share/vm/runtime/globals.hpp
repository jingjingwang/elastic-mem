...
#define RUNTIME_FLAGS(develop, develop_pd, product, product_pd, diagnostic, experimental, notproduct, manageable, product_rw, lp64_product) \
  ...
  product(bool, UseParallelGC, false,                                       \
          "Use the Parallel Scavenge garbage collector")                    \
                                                                            \
  product(bool, ScavengeAfterFullGC, false,                                 \
          "Scavenge youngest generation after each full GC, "               \
          "used with UseParallelGC")                                        \
                                                                            \
  product(bool, ElasticMem, false,                                          \
          "Elastic memory space.")                                          \
                                                                            \
  ...
  product(uintx, InitialHeapSize, 0,                                        \
          "Initial heap size (in bytes); zero means use ergonomics")        \
                                                                            \
  product(uintx, JVMPort, 0,                                                \
          "Port number of this JVM to listen to heap changes")              \
                                                                            \
  product(uintx, GCTriggerMode, 0,                                          \
          "Mode to trigger GC, 0: internel, 1:rely on external")            \
                                                                            \
